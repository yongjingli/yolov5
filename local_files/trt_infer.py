...
class YoloDetectionTrt:
    def __init__(self, onnx_path, batch_size=1):
        ...
        print('YoloDetectionTrt Initial Done...')

    def infer_cv_img(self, cv_img):
        img_input, pad_info = self.img_pre_process(cv_img)
        prediction = self.get_trt_prediction(img_input)
    ...
    def infer_batch_cv_imgs(self, cv_imgs):
        ...
        batch_prediction = self.get_trt_prediction(img_inputs)
...
def trt_infer_video(onnx_path, video_path):
    batch_size = 2

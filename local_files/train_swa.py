...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    train_path = [data_dict['train'], data_dict['wider_person_train'], data_dict['crowd_person_train'], data_dict['local1111_train'], data_dict['background'], data_dict['exdark_train']]
    ...
    freeze = ['model.%s.' % x for x in range(10)]  # parameter names to freeze (full or partial)  #backbone
    ...
    cut_b = int(len(dataloader) / accumulate) * accumulate   # only process [0:cut_b] data
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            tags = ['train/box_loss', 'train/obj_loss', 'train/cls_loss',  # train loss
                    ...
                    'val/box_loss', 'val/obj_loss', 'val/cls_loss' ]  # params
            ...
            if save:
                ...
                torch.save(ckpt_origin, os.path.join(os.path.split(last)[0], "swa_" + str(epoch) + ".pt"))
